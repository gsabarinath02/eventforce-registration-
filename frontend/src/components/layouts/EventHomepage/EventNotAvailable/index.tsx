...
export const EventNotAvailable = () => {
    return (
        <GenericErrorPage
            ...
            buttonText={isEventforce() ? t`Create your own event` : undefined}
            buttonUrl={isEventforce() ? "https://app.hi.events/auth/register?utm_source=app.hi.events&utm_content=organizer-not-found/create-event" : undefined}

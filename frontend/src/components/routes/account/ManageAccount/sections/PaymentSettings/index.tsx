    ...
    return (
        <div className={paymentClasses.stripeInfo}>
            ...
            <Text size="sm" c="dimmed" mb="lg">
                {getConfig("VITE_APP_NAME", "Eventforce")} charges platform fees to maintain and improve our services. These fees are automatically deducted from each transaction.
            </Text>

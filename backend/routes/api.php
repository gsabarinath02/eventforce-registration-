...
use HiEvents\Http\Actions\Orders\Payment\Razorpay\RefundRazorpayOrderAction;
...
$router->middleware(['auth:api'])->group(
    function (Router $router): void {
        ...
        $router->post('/events/{event_id}/orders/{order_id}/razorpay/refund', RefundRazorpayOrderAction::class)->name('razorpay.refund-order');
...
$router->prefix('/public')->group(
    function (Router $router): void {
        ...
        $router->post('/events/{event_id}/order/{order_short_id}/razorpay/order', CreateRazorpayOrderActionPublic::class)->name('razorpay.create-order');
        $router->post('/events/{event_id}/order/{order_short_id}/razorpay/verify', VerifyRazorpayPaymentActionPublic::class)->name('razorpay.verify-payment');
